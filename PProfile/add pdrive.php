          ...
          <form action="add pdrive1.php" class="templatemo-login-form" method="POST" enctype="multipart/form-data">
            <div class="row form-group">
              <div class="col-lg-6 col-md-6 form-group">
                ...
                <input type="text" name="compny" class="form-control" id="inputFirstName" placeholder="company" required>
              </div>
              <div class="col-lg-6 col-md-6 form-group">
              ...
              <div class="col-lg-6 col-md-6 form-group">
                <label class="control-label templatemo-block" required>Campus/Pool</label>
              ...
              <div class="col-lg-6 col-md-6 form-group">
                ...
                <input type="text" name="sslc" class="form-control" id="sslc" placeholder="" required>
              </div>
              <div class="col-lg-6 col-md-6 form-group">
              ...
              <div class="col-lg-6 col-md-6 form-group">
                <label class="control-label templatemo-block" required>Current Backlogs</label>
              ...
              <div class="col-lg-6 col-md-6 form-group">
                <label class="control-label templatemo-block" required>History of Backlogs</label>
              ...
              <div class="col-lg-6 col-md-6 form-group">
                <label class="control-label templatemo-block" required>Break of Studies</label>
