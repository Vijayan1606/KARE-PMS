...
// Query to fetch approved ECE students
$sql = "SELECT * FROM basicdetails WHERE Approve='1' AND Branch='ECE' LIMIT ?, ?";
        ...
        <div class="templatemo-sidebar">
            ...
            <nav class="templatemo-left-nav">
                <ul>
                    ...
                    <li><a href="ece.php" class="active"><i class="fa fa-home fa-fw"></i>ECE</a></li>
        ...
        <div class="templatemo-content col-1 light-gray-bg">
            ...
            <div class="templatemo-content-container">
                <div class="templatemo-content-widget white-bg">
                    <center>
                        <h2>Approved Students List of ECE</h2>
                    </center>
                ...
                <div class="pagination-wrap">
                    <ul class="pagination">
                        ...
                        $total_sql = "SELECT COUNT(*) AS total FROM basicdetails WHERE Approve='1' AND Branch='ECE'";
                        $total_result = $conn->query($total_sql);
                        $total_records = $total_result->fetch_assoc()['total'];
                        $total_pages = ceil($total_records / $num_rec_per_page);

                        if ($page > 1) {
                            echo "<li><a href='ece.php?page=" . ($page - 1) . "'>&lt;</a></li>";
                        }

                        for ($i = 1; $i <= $total_pages; $i++) {
                            echo "<li" . ($i == $page ? " class='active'" : "") . "><a href='ece.php?page=$i'>$i</a></li>";
                        }
