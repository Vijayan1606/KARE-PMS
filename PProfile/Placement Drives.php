          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                  <li><a href="../../Homepage/indes.php">Home KARE-PMS</a></li>
              ...
              <div class="templatemo-content-widget orangee-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    <h2 class="media-heading text-uppercase"><a href="../PProfile/add pdrive.php">Add Placement Drives</a></h2>
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <h2 class="media-heading text-uppercase"><a href="../PProfile/Placement Drives/update.php">Update Drive Details</a></h2><p>Update the Details of Drives happened and the Status of Students </p>
                  </div>
                </div>
              </div>
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    <h2 class="media-heading text-uppercase"><a href="../PProfile/Placement Drives/CompanyDetails.php">Company Details</a></h2>
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    <h2 class="media-heading text-uppercase"><a href="../PProfile/Placement Drives/drivehome.php">Drive Details</a></h2>
