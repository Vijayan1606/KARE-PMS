        ...
        <div class="templatemo-sidebar">
            ...
            <nav class="templatemo-left-nav">
                <ul>
                    ...
                    <li><a href="bs.php" class="active"><i class="fa fa-home fa-fw"></i>BASIC SCIENCE</a></li>
                </ul>
            </nav>
        </div>
        ...
        <div class="templatemo-content col-1 light-gray-bg">
            ...
            <div class="templatemo-content-container">
                <div class="templatemo-content-widget white-bg">
                    <center>
                        <h2>Approved Students List of BS</h2>
                    </center>
                        ...
                        <div class="panel panel-default table-responsive">
                            <table class="table table-striped table-bordered templatemo-user-table">
                                ...
                                <tbody>
                                    ...
                                    $stmt = $conn->prepare("SELECT * FROM basicdetails WHERE Approve='1' AND Branch='BS' LIMIT ?, ?");
                ...
                <div class="pagination-wrap">
                    <ul class="pagination">
                        ...
                        $sql = "SELECT COUNT(*) AS total FROM basicdetails WHERE Approve='1' AND Branch='BS'";
