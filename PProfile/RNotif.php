...
// Optional: Fetch notifications from the database (pseudo-code)
$notifications = []; // Replace this with actual database fetching logic
?>
        ...
        <aside class="templatemo-sidebar">
            ...
            <nav class="templatemo-left-nav">
                <ul>
                    ...
                    <li><a href="Students Eligibility.php"><i class="fa fa-check-square fa-fw"></i>Students Eligibility Status</a></li>
        ...
        <main class="templatemo-content col-1 light-gray-bg">
            ...
            <div class="templatemo-content-container">
                <div class="templatemo-content-widget white-bg">
                    <center>
                        <h2 class="margin-bottom-10">Read Messages</h2>
                        <p>Notifications from Placement Department and Principal</p>
                    </center>

                    <!-- Display notifications (pseudo-code) -->
                        ...
                        <?php else: ?>
                            <ul>
                                <?php foreach ($notifications as $notification): ?>
                                    <li>
                                        <strong><?php echo htmlspecialchars($notification['subject']); ?></strong><br>
